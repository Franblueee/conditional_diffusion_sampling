...
from .functional import la_step
...
class LAKernel(Kernel):
    def __init__(
        ...
        self._step_fn = lambda target, state, step_size: la_step(
    ...
    def step(self, target, state: KernelState, step_size: torch.Tensor) -> Tuple[KernelState, None]:
