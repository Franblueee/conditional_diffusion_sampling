# nohup python -u run_pt_mlp_posterior.py > run_pt_mlp_posterior.log 2>&1 &
...
grid_list = [
    {
        ...
        "sampler.params.beta_schedule.n_replicas": [3, 5],
        ...
        "sampler.params.reference.type": ["gaussian"],
        "sampler.params.reference.std": [1.0],
    }
]
