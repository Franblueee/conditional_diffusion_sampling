# nohup python -u run_smc_lj.py > run_smc_lj.log 2>&1 &
...
grid_list = [
    {
        ...
        "sampler.params.beta_schedule.min_val": [0.8],
        "sampler.params.beta_schedule.optimize": [False],
        "sampler.params.kernel.name": ["mala"],
        "sampler.params.kernel.n_leapfrog_steps": [0],
        "sampler.params.n_particles": [10, 100, 1000],
        "sampler.params.resampling_method": ["systematic"],
        "sampler.params.resampling_threshold": [1.0],
        "sampler.params.step_size": [0.001],
